...
import {onAuthStateChanged, auth, signOut ,signInWithPopup, GoogleAuthProvider,provider } from "./firebase.js";
onAuthStateChanged(auth, (user) => {
  if (user) {
    ...
    if (
      location.pathname !== "/index.html" && location.pathname !== "/register.html"
    ) {
      window.location = "/index.html";
    }
    // ...
